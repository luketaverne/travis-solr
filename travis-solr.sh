...
download_and_run() {
    case $1 in
        ...
        5.0.0)
            ...
            ;;
        5.1.0)
            url="http://archive.apache.org/dist/lucene/solr/5.1.0/solr-5.0.0.tgz"
            dir_name="solr-5.1.0"
            dir_conf="collection1/conf/"
            ;;
        5.2.0)
...
check_version() {
    case $1 in
        3.5.0|3.6.0|3.6.1|3.6.2|4.0.0|4.1.0|4.2.0|4.2.1|4.3.1|4.4.0|4.5.0|4.5.1|4.6.0|4.6.1|4.7.0|4.7.1|4.7.2|4.8.0|4.8.1|4.9.0|4.9.1|4.10.0|4.10.1|4.10.2|4.10.3|4.10.4|5.0.0|5.1.0|5.2.0|5.2.1|5.3.0|5.3.1);;
        *)
